...
export default function StyleCard({ style, onSelect, onReport }) {
  ...
  return (
    <div className="bg-white border border-zinc-200 rounded-xl overflow-hidden hover:border-purple-400 hover:shadow-md hover:shadow-purple-500/5 transition-all group flex flex-col justify-between relative">
      ...
      <div className="relative h-48 w-full overflow-hidden bg-zinc-100">
        ...
        <div className="absolute top-3 left-3">
          <span className="px-2 py-0.5 rounded text-[11px] font-mono bg-white/90 border border-zinc-200 text-zinc-800 backdrop-blur-sm shadow-xs font-semibold">
        ...
        {/* Artist Name & Title overlay on image */}
        <div className="absolute bottom-3 left-3 right-3 text-white">
          <h3 className="text-lg font-bold tracking-tight">{style.style_name}</h3>
          <p className="text-xs text-zinc-200 flex items-center gap-1 mt-0.5">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="grid grid-cols-2 gap-2 pt-1">
          <button
            ...
            className="w-full text-xs font-medium py-2 rounded-lg bg-zinc-100 hover:bg-zinc-200 text-zinc-800 border border-zinc-200 transition-colors flex items-center justify-center gap-1"
          >
          ...
          <button
            ...
            className="w-full text-xs font-semibold py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white border border-purple-500/20 transition-colors flex items-center justify-center gap-1 shadow-xs"
          >
